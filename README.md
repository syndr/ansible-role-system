...
# State for virtual environment packages (present, latest)
...
# Python packages that should be removed from the virtual environment
# - List of package names (version specs not needed for removal)
# - Packages listed here will be uninstalled from the venv
# - Useful for cleaning up unwanted dependencies or testing
